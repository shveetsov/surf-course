class Engine {
  ...
  @override
  String toString() {
    return 'название: $name, мощность: $power, объем двигателя: $engineCapacity';
  }
}

class Car {
  static const String brand = 'Subaru'; // Бренд (один бренд у всех автомобилей)
...
void main() {
  ...
  final car1 = Car(
      model: 'vm1',
      yearOfRelease: DateTime.utc(2001, 01, 1),
      engine: engA210,
      color: 'White');
  final car2 = Car(
      model: 'vm2',
      yearOfRelease: DateTime.utc(2004, 01, 1),
      engine: engA310,
      color: 'Black');
  final car3 = Car(
      model: 'vm3',
      yearOfRelease: DateTime.utc(2007, 01, 1),
      engine: engA410,
      color: 'White');
  final car4 = Car.fullEquipment(
      model: 'vm3',
      yearOfRelease: DateTime.utc(20010, 01, 1),
      engine: engA410,
      color: 'White');
